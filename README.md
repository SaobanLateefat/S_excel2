...
4. The converted total score can be used to grade the students. Create a new column named 'grades' for the grades of the students.									
    The following are the grades threshold: 80 - 100 (A*), 70 - 79 (A), 60 - 69 (B), 50 - 59 (C), 40 - 49 (D), 0 - 39 (U)									
5. Sort the data in terms of the students' grades									
